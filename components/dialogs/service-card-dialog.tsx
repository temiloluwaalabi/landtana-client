  ...
  if (!isMobile) {
    return (
      <Dialog open={openDialog} onOpenChange={setOpenDialog}>
        ...
        <DialogContent
          className="h-fit max-h-[700px] max-w-2xl overflow-hidden !rounded-[12px] bg-white px-0 py-4"
          ...
          <AnimatePresence>
            ...
            >
              ...
              >
                ...
                <DialogHeader className="sticky left-0 top-0 z-10 size-full border-b border-slate-100 bg-white/80 p-8 pb-14 backdrop-blur-md">
    ...
    <Drawer open={openDialog} onOpenChange={setOpenDialog}>
      ...
      <DrawerContent className="no-focus bg-white !p-0">
        ...
        >
          ...
          <div className="absolute -left-16 -top-8 size-24 rounded-full bg-blue-100/40 blur-xl"></div>
          <div className="absolute -bottom-16 right-32 size-28 rounded-full bg-purple-100/30 blur-xl"></div>
          <DrawerHeader className="sticky left-0 top-0 z-10 w-full border-b border-slate-100 bg-white/80 px-8 py-6 backdrop-blur-md">
            <motion.div variants={itemVariants}>
              <DrawerTitle> {props.service.name}</DrawerTitle>
            </motion.div>
            <motion.div variants={itemVariants}>
              {/* <DrawerDescription className="mt-2 text-sm text-slate-600">
              Prices exclude hair extensions but include our complimentary hair
              wash service and blow dry.
              <span className="mt-1 block text-sm font-medium text-pink-500">
          ...
          <DrawerFooter className="fixed bottom-0 left-0 flex w-full items-center justify-center rounded-b-[12px] border-t border-slate-100  bg-white px-6 py-3">
            <motion.div
              className="flex w-full items-center justify-center"
              variants={itemVariants}
            >
