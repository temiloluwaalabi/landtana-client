...
const BookingDetailsPage: React.FC<BookingDetailsPageProps> = ({
  ...
  return (
    <MaxWidthContainer className="space-y-8 p-4">
      ...
      <div className="overflow-hidden rounded-lg bg-white ">
        <div className="flex flex-col md:flex-row">
          ...
          <div className="md:w-1/3">
            {booking.services[0]?.featured_image ? (
              <Image
                ...
                width={100}
                height={459}
                className="h-[459px] w-full rounded-lg border-4 border-primary object-cover"
              />
            ) : (
              <div className="flex h-[459px] w-full items-center justify-center rounded-lg bg-gray-300">
          ...
          <div className="p-6 md:w-2/3">
            ...
            {/* Status banner */}
            <div className={`mt-6 rounded-lg p-4 ${statusDetails.className}`}>
          ...
          <div className="space-y-2">
            {groupMembers.slice(0, booking.group_size).map((member, idx) => (
              <div key={idx} className="flex items-center">
                <div className="mr-2 flex size-8 items-center justify-center rounded-full bg-purple-200">
      ...
      <div className="mt-8">
        ...
        <div className="grid space-y-4 md:grid-cols-2 xl:grid-cols-3">
      ...
      <div className="mt-8 rounded-lg bg-white p-6 shadow-md">
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          <button
            ...
            className="flex items-center rounded-lg border border-blue-500 px-4 py-2 text-blue-600 hover:bg-blue-50"
          >
            <svg
          ...
          <button
            ...
            className="flex items-center rounded-lg border border-yellow-500 px-4 py-2 text-yellow-600 hover:bg-yellow-50"
          >
            <svg
              className="mr-2 size-5"
              fill="currentColor"
          ...
          <button
            ...
            className="flex items-center rounded-lg bg-gray-200 px-4 py-2 text-gray-700 hover:bg-gray-300"
          >
            <svg
              className="mr-2 size-5"
              fill="currentColor"
      ...
      {(booking.additional_notes || booking.status === "PENDING") && (
        <div className="mt-8 rounded-lg border border-gray-200 bg-gray-50 p-6">
          <h3 className="mb-2 font-medium text-gray-800">PS: Note</h3>
      ...
      <div className="mt-8 rounded-lg border border-blue-200 bg-blue-50 p-6">
        <h3 className="mb-2 font-medium text-gray-800">Booking Policies</h3>
        <ul className="space-y-2 text-sm text-gray-600">
          <li className="flex items-start">
            <svg
              className="mr-2 mt-0.5 size-5 text-blue-500"
              fill="currentColor"
              viewBox="0 0 20 20"
            >
              <path
