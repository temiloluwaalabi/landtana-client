...
const GreenVariant = () => {
  return (
    <MaxWidthContainer className="relative flex h-[70vh] items-center overflow-hidden bg-primary pt-14 md:h-[75vh] lg:h-[90vh]">
      {/* Animated background elements */}
      <motion.div
        initial={{ opacity: 0, scale: 0.8 }}
        animate={{ opacity: 1, scale: 1 }}
        transition={{ duration: 1.5, ease: "easeOut" }}
        className="absolute bottom-0 right-0 z-40 mr-[-120px] size-[400px] bg-[url(https://res.cloudinary.com/davidleo/image/upload/v1740754941/landtana/IMG-20250114-WA0043-removebg-preview_lk0qup_aapr2q.png)] bg-contain bg-[right_100%] bg-no-repeat md:size-[550px] lg:size-[600px] xl:size-[700px] 2xl:size-[800px]"
      />
      ...
      <motion.div
        ...
        className="absolute bottom-0 right-0 size-[200px] bg-[url(https://res.cloudinary.com/davidleo/image/upload/v1739729649/landtana/Vector_ypxpyp.png)] bg-contain bg-[0%_0%] bg-no-repeat md:size-[400px] lg:size-[350px] xl:size-[600px]"
      />
