...
type SidebarContext = {
  ...
  isMobile: boolean;
  isCollapsed: boolean;
  openCollapsed: boolean; // 👈 NEW STATE
  setOpenCollapsed: (open: boolean) => void; // 👈 NEW STATE
  toggleSidebar: () => void;
};
...
>(
  (
    ...
    }, [isMobile, isCollapsed, setOpen, setOpenMobile, setOpenCollapsed]);
      ...
      return (
        <>
          <div
            ...
            data-state={state}
            data-collapsible={state === "collapsed" ? collapsible : "icon"}
